...
# for determining the time to sell and buy, look at the slopes of the
# MACD and what the values are
...
if sector:
    print(f"the stock {ticker} is in the {sector} sector.")

# tech_tickers = yf.Tickers('FTEC').tickers
...
# ma_slope = np.gradient(stock_data['10-day MA'])
# print('10 day moving average',stock_data)

# print('ma slope', ma_slope)
